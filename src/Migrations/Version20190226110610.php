 ...
 */
final class Version20190226110610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD description LONGTEXT DEFAULT NULL, ADD rating SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP description, DROP rating');
    }
}
